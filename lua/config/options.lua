...
opt.signcolumn = "yes" -- Always show the signcolumn, otherwise ita would shift the text each time
...
opt.timeoutlen = 250 -- Lower than default (1000) to quickly trigger which-key
opt.undofile = true
